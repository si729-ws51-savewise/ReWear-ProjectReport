...
|   3.1   | 24/11/23 | Adrian Melgar | Studen Outcome                       |  
|   3.2   | 24/11/23 | Fabrizio Torres | Studen Outcome                       | 
|   3.3   | 24/11/23 | Sebastian Bustinza | Studen Outcome                       |  
|   3.4   | 24/11/23 | Fabrizio Torres | Sprint Backlog                       | 
|   3.5   | 24/11/23 | Fabrizio Torres | Sprint Plannig                       | 
|   3.6   | 24/11/23 | Fabrizio Torres | Index                       | 
|   3.7   | 24/11/23 | Adrian Melgar | Development Evidence for Sprint Review                      |  
|   3.8   | 24/11/23 | Adrian Melgar | Testing Suite Evidence for Sprint Review                      |  
|   3.9   | 24/11/23 | Adrian Melgar | Execution Evidence for Sprint Review                      |  
|   3.10   | 24/11/23 | Adrian Melgar | Services Documentation Evidence for Sprint Review                      |  
|   3.11   | 24/11/23 | Adrian Melgar | Software Deployment Evidence for Sprint Review                      |  
|   3.12   | 24/11/23 | Adrian Melgar | Team Collaboration Insights during Sprint                      | 
|   4.0   | 24/11/23 | Fabrizio Torres<br>Adrian Melgar<br>Sebastian Bustinza | Sprint 3                      | 
...
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería | **TB1**<br>*Fabrizio Torres*<br>Se desarrolo el analisis de las entrevistas que sirvieron para la creacion de arquetipos y aportar al Needflinding que influirá para User Personas y se implementó el index para el sprint 1.<br>**TP**<br>*Fabrizio Torres*<br>Mejoró la experiencia del usuario corrigiendo elementos de Web Applications UX/UI Design y contribuyó al proyecto implementando el feature store en el sprint 1 y el feat home en el sprint 2.<br>**TB2**<br>*Fabrizio Torres*<br> Aporté en la parte de frontend , corrigiendo errores e implementando secciones dentro del app web.<br> **TF**<br>*Fabrizio Torres*<br>Se modifico las ramas y puntos dentro del landing.                                                                                                                                     | La coordinación en equipo para esta entrega no fue del todo óptima. Sin embargo, grupalmente buscamos las salidas para completar los distintos artefactos y también la identificación de los segmentos a los cuales va destinada la solución.     |

|                                                                                                                                                                                      | **TB1**<br>*Luis Sagastegui*<br> Gestionó eficientemente la documentación del proyecto, siguiendo los valores y principios establecidos.<br> **TP**<br>*Luis Sagastegui*<br>	Se precisó las habilidades de cada compañero para brindar un enfoque distinto para el desarrollo del proyecto, también se subsanó los puntos de mejora.<br>**TB2**<br>*Luis Sagastegui*<br>	                                                                                                                                                                                                                                                               | 	                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                      | **TB1**<br>*Josue Valverde*<br>Coordinó la distribución de tareas entre los miembros del equipo para comprender a los segmentos objetivo y crear prototipos de productos, como la landing page.<br> **TP**<br>*Josue Valverde*<br>En esta etapa, nuestro trabajo se enfocó en diferentes aspectos del proyecto, sin acciones específicas para informar.<br>	**TB2**<br>*Josue Valverde*<br>Trabajé en la implementación de las secciones restantes del frontend y contribuí en el desarrollo en fase inicial del backend                                                                                                                | 	                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                      | **TB1**<br>*Adrian Melgar*<br> No participó (cambio de grupo)  <br>**TP** <br>*Adrian Melgar*<br>No participó (cambio de grupo) <br>**TB2** <br>*Adrian Melgar*<br>Se completó la implementación de las secciones restantes y trabajando en la fase final de la aplicación web e implemento la primera version del enpoint de usuarios en el backend.<br>**TF**<br>*Adrian Melgar*<br>Se refacciono el endpoint de users para que utilice JWT en la autentificción y se modifico el endpoint de productos para que devuelva la información de cada producto en el formato adecuado.	                                                                                                                                                                                                                                                                                                                                                        | 	                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                      | **TB1**<br>*Sebastian Bustinza*<br>No participó (cambio de grupo)   <br>**TP** <br>*Sebastian Bustinza*<br>No participó (cambio de grupo)<br>**TB2** <br>*Sebastian Bustinza*<br>Conduje entrevistas de validación con los usuarios con el propósito de entender su vivencia en relación a la aplicación. Esto permitió compartir el estado actual de avance del proyecto y obtener comentarios acerca de la percepción del cliente sobre la propuesta. <br>**TF** <br>*Sebastian Bustinza*<br>Implementación de mejoras en el Landing page, participé activamente de todas las reuniones.                                                                                                                                                                                                                            | 	                                                                                                                                                                                                                                                 |
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.   | **TB1**<br>*Fabrizio Torres*<br>Se investigo acerca de las plataformas de gestión de compra y venta de ropa .<br>**TP**<br>*Fabrizio Torres*<br>Se busco información acerca de las tiendas online para implmentarlo en nuestro proyecto.<br>**TB2**<br>*Fabrizio Torres*<br> Se replanteo las acciones para poder realizar el Sprint 3 . <br> **TF**<br>*Fabrizio Torres*<br> Se completó el infome y algunas vistas del landing que estaban mal hechas corriegiendose.                                                                                                                                                                                                                                                                                               | Grupalmente hemos logrado un significativo avance del trabajo. No obstante, la organización y coordinación entre miembros no es del todo adecuada aun. A pesar de ello, el equipo hizo un esfuerzo significativo para llevar adelante el proyecto |
|                                                                                                                                                                                      | **TB1**<br>*Luis Sagastegui*<br>Se precisó la solución a un frente social para la mejora continúa del planeta y los seres que lo rodean.  <br>**TP**<br>*Luis Sagastegui*<br> Se remplanteó la idea y los objetivos para el proyecto con el desarrollo de cada una de las partes de los miembros del proyecto.<br>**TB2**<br>*Luis Sagastegui*<br>Llevé a cabo entrevistas de validación con los usuarios con el objetivo de indagar en su vivencia en relación con la aplicación. Esto permitió transmitir el progreso actual del proyecto y obtener comentarios acerca de la aceptación por parte de los clientes hacia la propuesta. | 	                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                      | **TB1**<br>*Josue Valverde*<br>Responsable de encabezar la etapa del sprint que abarca tanto el backlog como la planificación del sprint. Además, desempeño un papel activo en el diseño de la página de inicio y su adaptación a dispositivos móviles en Figma, así como en la versión responsive de la aplicación web.<br>**TP**<br>*Josue Valverde*<br>Se programaron reuniones de seguimiento y se creó un video resumen del sprint 2. <br>**TB2**<br>*Josue Valverde*<br> Se programaron reuniones de seguimiento y se creó un video resumen del sprint 3 y aplicación de la mejora continua con respecto al Sprint 2              | 	                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                      | **TB1**<br>*Adrian Melgar*<br> No participó (cambio de grupo)  <br>**TP** <br>*Adrian Melgar*<br>No participó (cambio de grupo) <br>**TB2** <br>*Adrian Melgar*<br>Se participo en reuniones continuas con el equipo, y se explico que tareas estabamos reallizando, como ibamos y si teniamos algun probema.	<br>**TF**<br>*Adrian Melgar*<br> En base a las entrevistas de validación realizadas en la TB2 se ajusto el desarrollo de los endpoints del backend y se modificó la información que estos devuelven.                                                                                                                                                                                                                                                                                                                                                                  | 	                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                      | **TB1**<br>*Sebastian Bustinza*<br>No participó (cambio de grupo)   <br>**TP** <br>*Sebastian Bustinza*<br>No participó (cambio de grupo)<br>**TB2** <br>*Sebastian Bustinza*<br>Conduje entrevistas de validación con los usuarios con el propósito de entender su vivencia en relación a la aplicación. Esto permitió compartir el estado actual de avance del proyecto y obtener comentarios acerca de la percepción del cliente sobre la propuesta.**TF** <br>*Sebastian Bustinza*<br>Implementación de mejoras en el Landing page, participé activamente de todas las reuniones, mejore en el skill de creación de secciones.	                                                                                                                                                                                | 	                                                                                                                                                                                                                                                 |
...
1.1.2. [Perfiles de integrantes del equipo](Informe.md#112-perfiles-de-integrantes-del-equipo)

1.2. Solution Profile

1.2.1 [Antecedentes y problemática](Informe.md#121-antecedentes-y-problemática)

1.2.2 Lean UX Process

1.2.2.1. [Lean UX Problem Statements](Informe.md#1221-lean-ux-problem-statements)

1.2.2.2. [Lean UX Assumptions](Informe.md#1222-lean-ux-assumptions)

1.2.2.3. [Lean UX Hypothesis Statements](Informe.md#1223-lean-ux-hypothesis-statements)

1.2.2.4. [Lean UX Canvas](Informe.md#1224-lean-ux-canvas)

1.3. [Segmentos objetivo](Informe.md#13-segmentos-objetivo)

## Capítulo II: Requirements Elicitation & Analysis

2.1. Competidores.

2.1.1. [Análisis competitivo](Informe.md#211-análisis-competitivo)

2.1.2. [Estrategias y tácticas frente a competidores](Informe.md#212-estrategias-y-tácticas-frente-a-competidores)

2.2. Entrevistas.

2.2.1. [Diseño de entrevistas](Informe.md#221-diseño-de-entrevistas)

2.2.2. [Registro de entrevistas](Informe.md#222-registro-de-entrevistas)

2.2.3. [Análisis de entrevistas](Informe.md#223-análisis-de-entrevistas)

2.3. [Needfinding](Informe.md#23-needfinding)

2.3.1. [User Personas](Informe.md#231-user-personas)

2.3.2. [User Task Matrix](Informe.md#232-user-task-matrix)

2.3.3. [User Journey Mapping](Informe.md#233-user-journey-mapping)

2.3.4. [Empathy Mapping](Informe.md#234-empathy-mapping)

2.3.5. [As-is Scenario Mapping](Informe.md#235-as-is-scenario-mapping)

## Capítulo III: Requirements Specification

3.1. [To-Be Scenario Mapping](Informe.md#31-to-be-scenario-mapping)

3.2. [User Stories](Informe.md#32-user-stories)
...
5.2.4. [Sprint 4](Informe.md#524-sprint-4)

5.2.4.1. [Sprint Planning 4](Informe.md#5241-sprint-planning-4)

5.2.4.2. [Sprint Backlog 4](Informe.md#5242-sprint-backlog-4)

5.2.4.3. [Development Evidence for Sprint Review](Informe.md#5243-development-evidence-for-sprint-review)

5.2.4.4. [Testing Suite Evidence for Sprint Review](Informe.md#5244testing-suite-evidence-for-sprint-review)

5.2.4.5. [Execution Evidence for Sprint Review](Informe.md#5245execution-evidence-for-sprint-review)

5.2.4.6. [Services Documentation Evidence for Sprint Review](Informe.md#5246services-documentation-for-sprint-review)

5.2.4.7. [Software Deployment Evidence for Sprint Review](Informe.md#5247software-deployment-evidence-for-sprint-review)

5.2.4.8. [Team Collaboration Insights during Sprint](Informe.md#5248-team-collaboration-insights-during-sprint)
