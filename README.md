...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería | <strong><em>Fabrizio Torres</em></strong><ul><li><strong>TB1</strong><br><em>Fabrizio Torres</em><br>Se desarrolló el análisis de las entrevistas que sirvieron para la creación de arquetipos y aportar al Needfinding que influirá para User Personas y se implementó el index para el sprint 1.</li><li><strong>TP</strong><br><em>Fabrizio Torres</em><br>Mejoró la experiencia del usuario corrigiendo elementos de Web Applications UX/UI Design y contribuyó al proyecto implementando el feature store en el sprint 1 y el feat home en el sprint 2.</li><li><strong>TB2</strong><br><em>Fabrizio Torres</em><br>Aporté en la parte de frontend, corrigiendo errores e implementando secciones dentro del app web.</li><li><strong>TF</strong><br><em>Fabrizio Torres</em><br>Se modificó las ramas y puntos dentro del landing.</li></ul> | La coordinación en equipo para esta entrega no fue del todo óptima. Sin embargo, grupalmente buscamos las salidas para completar los distintos artefactos y también la identificación de los segmentos a los cuales va destinada la solución.     |
|                                                                                                                                                                        | <ul><li><strong>TB1</strong><br><em>Luis Sagastegui</em><br>Gestionó eficientemente la documentación del proyecto, siguiendo los valores y principios establecidos.</li><li><strong>TP</strong><br><em>Luis Sagastegui</em><br>Se precisó las habilidades de cada compañero para brindar un enfoque distinto para el desarrollo del proyecto, también se subsanó los puntos de mejora.</li><li><strong>TB2</strong><br><em>Luis Sagastegui</em><br></li></ul>                                                                       |                                                                                                                                                                                                                                                      |
|                                                                                                                                                                        | <ul><li><strong>TB1</strong><br><em>Josue Valverde</em><br>Coordinó la distribución de tareas entre los miembros del equipo para comprender a los segmentos objetivo y crear prototipos de productos, como la landing page.</li><li><strong>TP</strong><br><em>Josue Valverde</em><br>En esta etapa, nuestro trabajo se enfocó en diferentes aspectos del proyecto, sin acciones específicas para informar.</li><li><strong>TB2</strong><br><em>Josue Valverde</em><br>Trabajé en la implementación de las secciones restantes del frontend y contribuí en el desarrollo en fase inicial del backend</li></ul>                                       |                                                                                                                                                                                                                                                      |
|                                                                                                                                                                        | <strong><em>Adrian Melgar</em></strong><ul><li><strong>TB1</strong><br><em>Adrian Melgar</em><br>No participó (cambio de grupo)</li><li><strong>TP</strong><br><em>Adrian Melgar</em><br>No participó (cambio de grupo)</li><li><strong>TB2</strong><br><em>Adrian Melgar</em><br>Se completó la implementación de las secciones restantes y trabajando en la fase final de la aplicación web e implementó la primera versión del endpoint de usuarios en el backend.</li><li><strong>TF</strong><br><em>Adrian Melgar</em><br>Se refactorizó el endpoint de users para que utilice JWT en la autenticación y se modificó el endpoint de productos para que devuelva la información de cada producto en el formato adecuado.</li></ul> |                                                                                                                                                                                                                                                      |
|                                                                                                                                                                        | <strong><em>Sebastian Bustinza</em></strong><ul><li><strong>TB1</strong><br><em>Sebastian Bustinza</em><br>No participó (cambio de grupo)</li><li><strong>TP</strong><br><em>Sebastian Bustinza</em><br>No participó (cambio de grupo)</li><li><strong>TB2</strong><br><em>Sebastian Bustinza</em><br>Conduje entrevistas de validación con los usuarios con el propósito de entender su vivencia en relación a la aplicación. Esto permitió compartir el estado actual de avance del proyecto y obtener comentarios acerca de la percepción del cliente sobre la propuesta.</li><li><strong>TF</strong><br><em>Sebastian Bustinza</em><br>Implementación de mejoras en el Landing page, participé activamente de todas las reuniones, mejoré en el skill de creación de secciones.</li></ul>                                       |                                                                                                                                                                                                                                                      |
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.    | <strong><em>Fabrizio Torres</em></strong><ul><li><strong>TB1</strong><br><em>Fabrizio Torres</em><br>Se investigó acerca de las plataformas de gestión de compra y venta de ropa.</li><li><strong>TP</strong><br><em>Fabrizio Torres</em><br>Se buscó información acerca de las tiendas online para implementarlo en nuestro proyecto.</li><li><strong>TB2</strong><br><em>Fabrizio Torres</em><br>Se replanteó las acciones para poder realizar el Sprint 3.</li><li><strong>TF</strong><br><em>Fabrizio Torres</em><br>Se completó el informe y algunas vistas del landing que estaban mal hechas corrigiéndose.</li></ul>                      | Grupalmente hemos logrado un significativo avance del trabajo. No obstante, la organización y coordinación entre miembros no es del todo adecuada aún. A pesar de ello, el equipo hizo un esfuerzo significativo para llevar adelante el proyecto.                      |
|                                                                                                                                                                        | <strong><em>Luis Sagastegui</em><ul><li><strong>TB1</strong><br><em>Luis Sagastegui</em><br>Se precisó la solución a un frente social para la mejora continua del planeta y los seres que lo rodean.</li><li><strong>TP</strong><br><em>Luis Sagastegui</em><br>Se replanteó la idea y los objetivos para el proyecto con el desarrollo de cada una de las partes de los miembros del proyecto.</li> | 
| | <strong><em>Adrian Melgar</em></strong><ul><li><strong>TB1</strong><br><em>Adrian Melgar</em><br>No participó (cambio de grupo)</li><li><strong>TP</strong><br><em>Adrian Melgar</em><br>No participó (cambio de grupo).</li><li><strong>TB2</strong><br><em>Adrian Melgar</em><br>Se participo en reuniones continuas con el equipo, y se explico que tareas estabamos reallizando, como ibamos y si teniamos algun probema.</li><li><strong>TF</strong><br><em>Adrian Melgar</em><br>En base a las entrevistas de validación realizadas en la TB2 se ajusto el desarrollo de los endpoints del backend y se modificó la información que estos devuelven.</li></ul>                      |                       | 
